...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand1(m_arm,m_wrist, m_extension, m_driveTrain, m_pneumatics));
    ...
    m_driveTrain.setDefaultCommand(new Drive(leftJoystick::getY, rightJoystick::getY, m_driveTrain));
    m_driveTrain.SetMaxSpeed(0.7);
    // Configure default commands
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SUBSYSTEM_DEFAULT_COMMAND


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SUBSYSTEM_DEFAULTN_COMMAND

    // Configure autonomous sendable chooser
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
    m_chooser.addOption("Autobalance", new AutonomousCommand2(m_arm, m_wrist, m_extension, m_driveTrain, m_pneumatics));
    m_chooser.addOption("Test routine", new AutonomousCommand3(m_arm, m_wrist, m_extension, m_driveTrain, m_pneumatics));
    m_chooser.setDefaultOption("Auto1", new AutonomousCommand1(m_arm,m_wrist, m_extension, m_driveTrain, m_pneumatics));
  ...
  private void configureButtonBindings() {
      ...
      Driverbutton6.whileTrue(new ConditionalCommand( new InstantCommand(m_driveTrain::brakerelease),new InstantCommand(m_driveTrain::brake), m_driveTrain::brake_on));
