...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.addOption("Autobalance", new AutonomousCommand1(m_arm, m_wrist, m_extension, m_driveTrain, m_pneumatics));
    m_chooser.addOption("Test routine", new AutonomousCommand3(m_arm, m_wrist, m_extension, m_driveTrain, m_pneumatics));
    m_chooser.setDefaultOption("Auto1", new AutonomousCommand2(m_arm,m_wrist, m_extension, m_driveTrain, m_pneumatics));
