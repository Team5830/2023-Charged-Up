...
public class RobotContainer {
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.setDefaultOption("Autobalance", new AutonomousCommand2(m_arm, m_wrist, m_extension, m_driveTrain, m_pneumatics));
    //m_chooser.addOption("Test routine", new AutonomousCommand3(m_arm, m_wrist, m_extension, m_driveTrain, m_pneumatics));
    m_chooser.addOption("Auto1", new AutonomousCommand1(m_arm,m_wrist, m_extension, m_driveTrain, m_pneumatics));
