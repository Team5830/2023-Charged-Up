...
private final CommandGenericHID xroller = new CommandGenericHID(3);
  ...
  */
  private RobotContainer() {
    ...
    leftJoystick.getRawButtonPressed(0);
...
button6.onTrue(new Positioning(m_arm,m_wrist,m_extension, Position5.armAngle, Position5.wristAngle, Position5.extensionDistance));
